<div class="ec-page-wrapper">
  ...
  if($today2=='Sun')
    ...
    $thu='Chủ Nhật';*/
          ...
          upload($tentaptin, $tieude, $tieude_en, $mota,$mota_en, $noidung, $noidung_en);
        ...
        function upload($tentaptin, $tieude, $tieude_en, $mota,$mota_en, $noidung,$noidung_en)
        {
          require('db.php');
          ...
          $truyvan = "INSERT INTO du_an (hinhanh,tieude,tieude_en,mota,mota_en,noidung,noidung_en) VALUES ('" . $tentaptin . "','" . $tieude . "','" . $tieude_en . "', '" . $mota . "','" . $mota_en . "','" . $noidung . "','" . $noidung_en . "')";
                    ...
                    <div class="ec-vendor-upload-detail">
                      <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                          ...
                          <input name="mota" class="form-control" type="text" id="mota" size="90"
                            maxlength="150" />
                        </div>
                        <div class="col-md-12 mt-3">
                          <label for="inputEmail4" class="form-label fw-bold">Mô tả English</label>
                          <input name="mota_en" class="form-control" type="text" id="mota_en" size="90"
                            maxlength="150" />
                        </div>
                        <div class="col-md-12 mt-3">
