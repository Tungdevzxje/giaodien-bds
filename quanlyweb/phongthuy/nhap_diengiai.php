            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    if (isset($_POST['luu'])) {
                        ...
                        upload($namsinh, $gioitinh, $menh, $que, $thuoc, $huong, $mota, $noidung);
                        ...
                        setTimeout(() => {
                            window.location = 'quan_tri.php?p=diengiai&page=" . $page . "';
                        }, 2000);
                        </script>";
                    }

                    function upload($namsinh, $gioitinh, $menh, $que, $thuoc, $huong, $mota, $noidung)
                    {
                        require('db.php');
                        $truyvan = " INSERT INTO banmenh(namsinh,gioitinh,menh,que,thuoc,huong,mota,noidung) VALUES ('" . $namsinh . "'," . $gioitinh . ",'" . $menh . "','" . $que . "','" . $thuoc . "','" . $huong . "','" . $mota . "','" . $noidung . "')";
