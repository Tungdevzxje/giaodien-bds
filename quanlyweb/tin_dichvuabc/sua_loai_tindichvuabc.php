  ...
  <div class="ec-content-wrapper">
    <div class="content">
      <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        ...
        <div>
          <a href="quan_tri.php?p=them_tin_dichvuabc" class="btn btn-primary"> Thêm dịch vụ
          </a>
        </div>
      </div>
      <div class="row">
        ...
        function upload($thuocloai, $tentaptin, $noidung, $id, $url)
        {
          ...
          $truyvan = "update  loai_tin_dichvuabc set `thuocloai` = '$thuocloai' , `thuocloai_en` = '' , `hinhanh` = '$tentaptin' , `logo` = '', `noidung` = '$noidung' , `name_url` = '$url' , `noidung_en` = '' where id='$id'";
          ...
          if ($ketqua_truyvan) {
            ...
            echo "<script>
                    ...
                    setTimeout(() => {
                      window.location = 'quan_tri.php?p=danhsach_loai_tindichvuabc&page=" . $_GET["page"] . "';
                    }, 2000);
                  </script>";
          } else {
        ...
        include('db.php');
        $id = $_REQUEST["id"];
        $result = mysqli_query($link, "SELECT * FROM loai_tin_dichvuabc where id like '$id' ");
