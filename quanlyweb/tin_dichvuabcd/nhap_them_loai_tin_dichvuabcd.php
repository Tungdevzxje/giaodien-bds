  ...
  <div class="ec-content-wrapper">
    <div class="content">
      <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        ...
        <div>
          <a href="quan_tri.php?p=them_tin_dichvuabcd" class="btn btn-primary"> Thêm dich vụ
          </a>
        </div>
      </div>
      <div class="row">
        ...
        if (isset($_POST['luu'])) {
          ...
          echo "<script>window.location='quan_tri.php?p=danhsach_loai_tindichvuabcd" . $_GET["page"] . "'</script>";

        }
        function upload($thuocloai, $thuocloai_en, $tentaptin, $url)
        {
          require('db.php');
          $truyvan = " INSERT INTO loai_tin_dichvuabcd (thuocloai,thuocloai_en,trangchu,hinhanh,logo,noidung,noidung_en,name_url) VALUES ('" . $thuocloai . "', '" . $thuocloai_en . "','0','" . $tentaptin . "','','','','" . $url . "')";
        ...
        function xoataptin($tentaptin)
        {
          ...
          $truyvan = "DELETE FROM loai_tin_dichvuabcd WHERE hinhanh = '$tentaptin'";
