      ...
      <div class="content">
        ...
        <div class="row">
          ...
          if (isset($_POST['luu'])) {
            ...
            $danhmuc = '1';
            $linkurl = slugify($_POST['tieude']);
            $linkurl2 = slugify($_POST['tieude_en']);
            upload($noidung, $tentaptin, $tenhinhanh1, $tenhinhanh2, $tenhinhanh3, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $noidung_en, $mota_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl, $linkurl2);
            ...
            echo "<script>
              ...
              setTimeout(() => {
                window.location = 'quan_tri.php?p=ds_tin_dichvuabcd&page=" . $page . "';
              }, 2000);
            </script>";
            exit;
          }
          function upload($noidung, $tentaptin, $tenhinhanh1, $tenhinhanh2, $tenhinhanh3, $tieude, $mota, $trangchu, $thuocloai, $tieude_en, $noidung_en, $mota_en, $title, $tukhoa, $tukhoa2, $ngay, $linkurl, $linkurl2)
          {
            require('db.php');

            // Xử lý đặc biệt với ký tự trong câu truy vấn
            $truyvan = "INSERT INTO tin_dichvuabcd (`hinhanh`,`hinhanh1`,`hinhanh2`,`hinhanh3`,`noidung`,`trangchu`,`mota`,`tieude`, `tieude_en`, `noidung_en`, `mota_en` ,`title`, `tukhoa`,`tukhoa2`,`ngay`,`linkurl`,`linkurl2`,`thuocloai`,`moi`) VALUES ( '$tentaptin', '$tenhinhanh1','$tenhinhanh2','$tenhinhanh3', '$noidung', '$trangchu', '$mota','$tieude', '$tieude_en', '$noidung_en', '$mota_en' ,'$title', '$tukhoa','$tukhoa2','$ngay', '$linkurl','$linkurl2','$thuocloai','0')";
          ...
          {
            // Chuyển về Unicode chuẩn (loại bỏ dấu tiếng Việt)
            $text = mb_convert_encoding($text, 'UTF-8', 'UTF-8');
            $text = iconv('UTF-8', 'ASCII//TRANSLIT//IGNORE', $text);

            // Xoá ký tự đặc biệt, giữ lại chữ, số và khoảng trắng
            $text = preg_replace('/[^A-Za-z0-9\s\-]/', '', $text);

            // Thay nhiều khoảng trắng bằng 1 gạch ngang
          ...
          {
            include('db.php');
            $tv = "select * from loai_tin_dichvuabcd ORDER BY id ASC";
