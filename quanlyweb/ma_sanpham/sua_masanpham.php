                    ...
                    <div class="ec-vendor-upload-detail">
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          ...
                          <input class="form-control" name="tieude_en" type="text" value="<?php echo "$tieude_en"; ?>"
                            id="tieude_en" size="90" maxlength="70" />
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                          ...
                          <textarea class="form-control" name="mota_en" id="textarea" cols="88"
                            rows="3"><?php echo "$mota_en"; ?></textarea>
                        </div>
                        <div class="col-md-6">
