...
switch ($_GET['thamso']) {
	...
	case "xemphongthuy":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('phong_thuy/xemphongthuy_en.php');

				break;

			default:

				include('phong_thuy/xemphongthuy.php');
	...
	case "xemtuoilamnha":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('phong_thuy/xemtuoilamnha_en.php');

				break;

			default:

				include('phong_thuy/xemtuoilamnha.php');
	...
	case "xemhuonglambep":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('phong_thuy/xemhuonglambep_en.php');

				break;

			default:

				include('phong_thuy/xemhuonglambep.php');
	...
	case "xemhuongbantho":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('phong_thuy/xemhuongbantho.php');
	...
	case "xemhuonglamviec":

			switch ($ngon_ngu_abc) {

				case "tieng_anh":

					include('phong_thuy/xemhuonglamviec.php');
	...
	case "xemhuonggiuongngu":

		switch ($ngon_ngu_abc) {

			case "tieng_anh":

				include('phong_thuy/xemhuonggiuongngu.php');
	...
	case "congcuphongthuy":

		switch ($ngon_ngu_abc) {

			case "tieng_anh":

				include('phong_thuy/congcuphongthuy_en.php');

				break;

			default:

				include('phong_thuy/congcuphongthuy.php');
	...
	case "chitiet_tinbds":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('tin_bds/chitiet_tinbds_en.php');
			...
			default:
				...
				include('tin_bds/chitiet_tinbds.php');
		}
	...
	case "tin_bds":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('tin_bds/tin_bds_en.php');
	...
	case "tin_bdsct":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('tin_bds/tin_bdsct_en.php');
	...
	case "chitiet_tindichvuabc":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('tin_dichvuabc/chitiet_tindichvuabc_en.php');

				break;

			default:

				include('tin_dichvuabc/chitiet_tindichvuabc.php');
		}
	...
	case "tin_dichvuabc":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('tin_dichvuabc/tin_dichvuabc_en.php');
			...
			default:
				...
				include('tin_dichvuabc/tin_dichvuabc.php');
		}

		break;

	case "tin_dichvuabcct":

		switch ($ngon_ngu_abc) {

			case "tieng_anh":

				include('tin_dichvuabc/tin_dichvuabcct_en.php');
			...
			default:
				...
				include('tin_dichvuabc/tin_dichvuabcct.php');
		}

		break;
	case "tin_dichvuabcctc":
		...
		switch ($ngon_ngu_abc) {
			...
			default:
				...
				include('tin_dichvuabc/tin_dichvuabcctc.php');
		}

		break;

	//tin dich vuabcd
	case "chitiet_tindichvuabcd":

		switch ($ngon_ngu_abc) {

			case "tieng_anh":

				include('tin_dichvuabcd/chitiet_tindichvuabcd_en.php');

				break;

			default:

				include('tin_dichvuabcd/chitiet_tindichvuabcd.php');
		}
	...
	case "tin_dichvuabcd":
		...
		switch ($ngon_ngu_abc) {
			...
			case "tieng_anh":
				...
				include('tin_dichvuabcd/tin_dichvuabcd_en.php');
			...
			default:
				...
				include('tin_dichvuabcd/tin_dichvuabcd.php');
		}

		break;

	case "tin_dichvuabcdct":

		switch ($ngon_ngu_abc) {

			case "tieng_anh":

				include('tin_dichvuabcd/tin_dichvuabcdct_en.php');
			...
			default:
				...
				include('tin_dichvuabcd/tin_dichvuabcdct.php');
		}

		break;
	case "tin_dichvuabcdctc":
		...
		switch ($ngon_ngu_abc) {
			...
			default:
				...
				include('tin_dichvuabcd/tin_dichvuabcdctc.php');
		}
