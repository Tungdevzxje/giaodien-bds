...
<main id="main" class="tren-duoi">
    <div id="content">
        <h4><i class="fas fa-table" style="margin-right: 8px;"></i>Nhập thông tin để xem hướng bàn làm việc phong
            thủy
        </h4>
        <form action="" method="post">
            ...
            <select name="huongbantho">
                <option value="">-- Hướng bàn làm việc --</option>
            ...
            <button type="submit" id="submit"><i class="fas fa-search"></i> Xem tư vấn hướng bàn làm việc</button>
        </form>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isset($link) && $link) {
                ...
                $query = "SELECT * FROM huong_lam_viec
                ...
                if ($data) {
                    echo "<div class='result-block' style='padding: 30px; border-radius: 12px; background: rgb(30 15 15 / 60%); backdrop-filter: blur(8px); margin-bottom: 40px;'>";

                    echo "<h4 style='margin-top:30px; font-size: 24px; text-align: center; color: #fff; line-height: 1.4;'>Tư vấn hướng bàn làm việc phong thủy cho người sinh ngày <span style='color: #ffc107;'>{$ngaysinh}/{$thangsinh}/{$namsinh} ({$gioitinh_str}),</span> với hướng bàn làm việc <span style='color: #ffc107;'>{$huongbantho_str}</span>:</h4>";
                    ...
                    echo "<p style='margin-bottom: 25px; font-size: 16px; color: #e0e0e0;'><strong>Hướng bàn làm việc hiện tại:</strong> {$huongbantho_str}</p>";
                    ...
                    foreach ($directions as $direction_pair) {
                        ...
                        if (!empty($direction_pair)) {
                            ...
                            if (strcasecmp($direction, $huongbantho_str) == 0) {
                                $current_altar_note = ' <span style="font-style: italic; color: #aaa;">(hướng bàn làm việc hiện tại của bạn)</span>';
                            }
                    ...
                    echo "<p style='color:#ccc; padding: 20px; background: rgba(0,0,0,0.5); border-radius: 8px; text-align: center;'>Không tìm thấy kết quả phù hợp với thông tin bạn nhập. Vui lòng kiểm tra lại ngày sinh, tháng sinh, năm sinh, giới tính và hướng bàn làm việc.</p>";
                }
            } else {
