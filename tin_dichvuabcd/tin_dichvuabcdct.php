...
<div class="bg-chitiet">
    <div class="row">
        <div style='padding:0px;'>
            ...
            require('db.php');
            $did = $_GET["url"];
            $tv = "select * from loai_tin_dichvuabcd where name_url='" . $_GET['url'] . "' order by id ";
        ...
        <div class="col-lg-12 main-content" style="padding-top: 10px;">
            ...
            <div class="container">
                <div class="row g-4">
                    ...
                    $sp = $link->prepare("SELECT COUNT(*) FROM tin_dichvuabcd WHERE thuocloai = ?");
                    $sp->bind_param('i', $id);
                    $sp->execute();
                    ...
                    $sp = $link->prepare("SELECT * FROM tin_dichvuabcd WHERE thuocloai = ? ORDER BY id DESC LIMIT ?, ?");
