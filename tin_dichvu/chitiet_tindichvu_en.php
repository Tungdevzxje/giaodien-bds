...
<div class="page-content">
            ...
            <div class="wt-bnr-inr-entry">
                ...
                <div class="p-tb20">
                    <div>
                        ...
                        $phanloai = mysqli_fetch_array(mysqli_query($link, "select * from  loai_tin_dichvu where id=" . $thuocloai . " limit 1"));
                        $mota = "$tv_2[mota]";
    ...
    padding-left: 5px;"><i class="fa fa-bars" style="padding-right:10px;"></i> RELATED NEWS</div>
                        ...
                        <div class="row">
                            ...
                            $pages = $p->findPages($count, $limit);
                            $sql = mysqli_query($link, "SELECT * FROM (SELECT * FROM tin_dichvu WHERE thuocloai = $thuocloai ORDER BY id DESC LIMIT 100) AS latest_20 ORDER BY RAND() LIMIT 6");
                            // Error handling
                            if (!$sql) {
