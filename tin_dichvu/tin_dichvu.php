...
<div class="page-content">
    ...
    <div class="section-full p-tb90 container">
        <div class="row gx-2 gy-3 justify-content-center mt-5"> <?php
        ...
        while ($tv_2 = mysqli_fetch_array($tv_1)) {
            ...
            ?>
                <div class="col-12 col-sm-6 col-md-4 col-lg-3 d-flex align-items-stretch">
                    <div class="ely-service-card w-100 d-flex flex-column rounded overflow-hidden shadow-sm" style="margin:0;">
                        <div class="ely-card-media" style="margin-bottom:0;">
                            <a href="<?= $link_url; ?>">
