...
<div class="page-content">
            ...
            <div class="wt-bnr-inr-entry">
                ...
                <div class="p-tb20">
                    <div>
                        ...
                        $phanloai = mysqli_fetch_array(mysqli_query($link, "select * from  loai_tin_tintuc where id=" . $thuocloai . " limit 1"));
                        $mota = "$tv_2[mota]";
                    ...
                    if (mysqli_num_rows($result) <> 0) {
                        ...
                        while ($row = mysqli_fetch_object($result)) {
                    		...
                    		<p style='font-size: 17px;' class='author_name'> $mota_en</p>
                               ...
                               <div style='font-size: 16px; font-family:'Arial', sans-serif;' class='author_name'>
                               $noidung_en
                                   </div>
    ...
    padding-left: 5px;"><i class="fa fa-bars" style="padding-right:10px;"></i> RELATED NEWS </div>
                    ...
                    <div class="row">
                        ...
                        $pages = $p->findPages($count, $limit);
                        $sql = mysqli_query($link, "SELECT * FROM (SELECT * FROM tin_tintuc WHERE thuocloai = $thuocloai ORDER BY id DESC LIMIT 100) AS latest_20 ORDER BY RAND() LIMIT 1,4");
                        // Error handling
                        if (!$sql) {
                ...
                <aside class="col-lg-3 col-md-12">
                    <div class="pinBox">
                        <?php include('menu_trai/lefttintuc_en.php'); ?>
                    </div>
                </aside>
            </div>
        </div>
