            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="product-details-content">
                        ...
                        <h6 class="details-info style-2"><span>Tags:</span> <a href="shop-details.html"> <b>accessories</b> <b>business</b></a></h6>
                    </div>
                </div>
            </div>
            <div class="single-tab">
                ...
                <div class="tab-content">
                    ...
                    <div class="review-items">
                        ...
                        <div class="admin-items d-flex flex-wrap flex-md-nowrap align-items-center pb-4">
                            <div class="admin-img pb-4 pb-md-0 me-4">
                                <img src="assets/img/shop/r-3.png" alt="image">
                            </div>
                            <div class="content p-4">
                                <div class="head-content pb-1 d-flex flex-wrap justify-content-between">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="products-box-items">
                            ...
                            <div class="product-thumb">
                                <img src="assets/img/product/p-1.jpg" alt="img">
                    ...
                    <div class="swiper-slide">
                        <div class="products-box-items">
                            ...
                            <div class="product-thumb">
                                <img src="assets/img/product/p-4.jpg" alt="img">
                                <ul class="product-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                    </li>
                    ...
                    <div class="swiper-slide">
                        <div class="products-box-items">
                            ...
                            <div class="product-thumb">
                                <img src="assets/img/product/p-3.jpg" alt="img">
                                <ul class="product-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                    </li>
                    ...
                    <div class="swiper-slide">
                        <div class="products-box-items">
                            ...
                            <div class="product-thumb">
                                <img src="assets/img/product/p-2.jpg" alt="img">
                                <ul class="product-icon d-grid justify-content-center align-items-center">
                                    <li>
                                        <a href="shop-cart.html"><i class="far fa-heart"></i></a>
                                    </li>
