...
<div id="main" style="padding-top:100px !important;padding: 20px; position: relative; z-index: 0;">
  <div>
    <div class="content">
...
<style>
    ...
    <div class="container top">
        <div class="section-content m-b50">
            ...
            <?php
            require('db.php');
            $tv = "SELECT * FROM tin_dichvuu ORDER BY id LIMIT 0,2";
                ...
                <div class="col-md-6 col-sm-6 d-flex">
                    <div class="wt-icon-box-wraper bx-style-1 p-a20 bg-white shadow-sm w-100 d-flex flex-column">
                        <div class="wt-post-media wt-img-effect zoom-slow mb-3">
                            <a href="<?= $link; ?>">
                                <img src="<?= $link_hinh; ?>" alt="<?= $tieude; ?>" class="img-fluid w-100"
                        ...
                        <div class="flex-grow-1 d-flex flex-column">
                            <h3 class="wt-tilte text-uppercase letter-spacing-1 font-weight-bold"
                                style="min-height: 50px; margin-bottom: 5px;">
                                <a href="<?= $link; ?>" class="text-dark"><b><?= $tieude; ?></b></a>
                            </h3>
                            <p class="flex-grow-1" style="max-height: 96px; overflow: hidden;"><?= $mota; ?></p>
                            <div class="text-end mt-2">
                                <a href="<?= $link; ?>" class="btn btn-sm btn-outline-dark text-uppercase">Xem thêm</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container">
    <div class="section-content m-b50">
        <div class="row">
            <?php
            require('db.php');
            $tv = "SELECT * FROM tin_dichvuu ORDER BY id LIMIT 8";
            $tv_1 = mysqli_query($link, $tv);
            while ($row = mysqli_fetch_array($tv_1)) {
                $id = $row['id'];
                $hinhanh = $row['hinhanh'];
                    ...
                    <div class="wt-icon-box-wraper bx-style-1 p-a10 left bg-white">
                        ...
                        <div class="col-md-4 col-sm-4 m-b10">
                            ...
                            <div class="wt-post-media wt-img-effect zoom-slow">
                                <a href="<?php echo "$link"; ?>"><img src="HinhCTSP/Hinhdichvu/<?php echo $hinhanh; ?>"
                                        title="<?php echo "$tieude"; ?>" alt="<?php echo "$tieude"; ?>" /></a>
                            </div>
                        ...
                        <div class="col-md-8 col-sm-8 m-b10">
                            ...
                            <p style="    height: 96px;
overflow: hidden;">     <?php echo "$mota"; ?></p>
